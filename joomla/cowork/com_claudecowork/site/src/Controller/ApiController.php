...
class ApiController extends BaseController
{
    ...
    private function loadEngine(): void
    {
        ...
        foreach (['SqlValue', 'RowSource', 'DbDumper', 'FileWalker', 'TarStream', 'Uploader', 'Extensions', 'SiteWriter', 'ChangeStamp', 'CoreUpgrader', 'FilesRestorer', 'Token', 'Engine', 'MysqliRowSource'] as $class) {
