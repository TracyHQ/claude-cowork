...
final class QuickstartContract
{
    ...
    public function multilingualAvailable(): bool { return $this->multilingual !== null && $this->packs !== null; }
    ...
    public function rebind(array $binding): void { $this->store->replace($binding); }
}
